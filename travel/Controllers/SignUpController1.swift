...
class SignUpController1: UIViewController {
    ...
    @objc private func signUpButtonTapped() {
        ...
        let studentInfoView = OnboardingController1()

        // Wrap it in a UIHostingController
        let hostingController = UIHostingController(rootView: studentInfoView)

        // If you are using a navigation controller, push the UIHostingController
        navigationController?.pushViewController(hostingController, animated: true)

        // If not using a navigation controller, present the UIHostingController modally
